...
public class OperadorExporterPDF {

	private List<Operador> listaOperador;

	public OperadorExporterPDF(List<Operador> listaOperador) {
		super();
	...
	private void escribirDatosDeLaTabla(PdfPTable tabla) {
		for (Operador empleado : listaOperador) {
			...
			tabla.addCell(String.valueOf(empleado.getNumero()));
